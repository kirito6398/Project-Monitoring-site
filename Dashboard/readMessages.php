...
if($_GET['rid']){
  $id=intval($_GET['rid']);
  $query=mysqli_query($con,"delete from discussion where id='$id'");
...
?>
                        <tr>
                          ...
                          <td>
                            <a href="readMessages.php?rid=<?php echo htmlentities($row['id']);?>"> <i class="fa fa-trash-o" style="color: #f05050"></i></a>
                          </td>
                        </tr>
<?php
$cnt++;
