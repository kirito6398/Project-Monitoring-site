...
if(isset($_POST['login']))
  {
    ...
    echo "<script>alert('login Sucessful');</script>";
        echo "<script type='text/javascript'> document.location = '../Dashboard/MentorDashboard.php'; </script>";
    } 
    else {
    ...
    <div class="login-box">
        ...
        <form method="post">
          ...
          <div class="user-box">
            ...
            <button class="btnNew sideMargin" type="button" onclick="window.location.href = '../RegisterPages/MentorRegister.php';">
                <span></span>
                <span></span>
                <span></span>
                <span></span>
